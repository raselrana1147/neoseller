...
public function frondHome(){

    $metas=Homemeta::all();
    $merchants=Admin::orderBy('total_sell',"DESC")->take(10)->get();
  
    return view('front.home',compact('metas','merchants'));
...
public function imagedownload($id){
    ...
    $product=Product::find($id);
            $files=[];
            $i=0;
         foreach($product->galleries as $images) {
                $files[] = public_path('assets/images/galleries/'.$images->photo);     
             } 
             Zipper::make(base_path('downloads/'.'gallaries.zip'))->add($files);
             Zipper::close(); 
            return response()->download(base_path('downloads/'.'gallaries.zip'));
    ...
    if ($type=='featured') {
     ...
     $products = Product::where('best','=',1)->where('status','=',1)->get();
        ...
        $products = Product::where('is_discount','=',1)->where('status','=',1)->get();
    }elseif ($type=='toprated') {
        $products = Product::where('top','=',1)->where('status','=',1)->get();
    }elseif ($type=='bigsave') {
        $products = Product::where('big','=',1)->where('status','=',1)->get();
    }

        
        //return count($feature_products);

        return view('front.viewallproduct',compact('ps','sliders','services','reviews','top_small_banners','large_banners','bottom_small_banners','products','type'));
    ...
    public function extraIndex(Request $request)
    {
        ...
        $ps = DB::table('pagesettings')->find(1);
        $partners = DB::table('partners')->get();
        $discount_products =  Product::where('is_discount','=',1)->where('status','=',1)->take(9)->get();
        $feature_products =  Product::where('featured','=',1)->where('status','=',1)->take(9)->get();
        $best_products = Product::where('best','=',1)->where('status','=',1)->take(9)->get();
        $top_products = Product::where('top','=',1)->where('status','=',1)->take(9)->get();;
        $big_products = Product::where('big','=',1)->where('status','=',1)->take(9)->get();;
        $hot_products =  Product::where('hot','=',1)->where('status','=',1)->take(9)->get();
        $latest_products =  Product::where('latest','=',1)->where('status','=',1)->take(9)->get();
        $trending_products =  Product::where('trending','=',1)->where('status','=',1)->take(9)->get();
        $sale_products =  Product::where('sale','=',1)->where('status','=',1)->take(9)->get();
