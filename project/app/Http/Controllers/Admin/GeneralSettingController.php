...
class GeneralSettingController extends Controller
{
    ...
    public function changeform(){
        $api=Api::get()->first();
        return view('admin.API.changeapi',compact('api'));
    }

     public function changeapi(Request $request,$id){
       $api=Api::find($id);
       $api->data=$request->data;
       $api->update();
       //$msg = 'Data Updated Successfully.';

       // return back()->response()->json($msg);   
       //return back();

         session()->flash('rmessage','updated sccuessfully');
         return back();
