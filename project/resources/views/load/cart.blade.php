										...
										<ul class="dropdown-cart-products">
											...
											<li class="product cremove{{ $product['item']['id'].$product['size'] }}">
													...
													<div class="content">
														...
														<span class="cart-product-info">
															<span class="cart-product-qty"
																id="cqt{{$product['item']['id'].$product['size']}}">{{$product['qty']}}</span><span>{{ $product['item']['measure'] }}</span>
															x <span
																id="prct{{$product['item']['id'].$product['size']}}">{{ App\Models\Product::convertPrice($product['item']['price']) }}</span>
														</span>
													</div>
												...
												<figure class="product-image-container">
													...
													<div class="cart-remove" data-class="cremove{{ $product['item']['id'].$product['size'] }}"
														data-href="{{ route('product.cart.remove',$product['item']['id'].$product['size']) }}"
