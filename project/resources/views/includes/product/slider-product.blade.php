...
<a href="{{ route('front.product', $prod->slug) }}" class="item">
	...
	<div class="item-img ">
		...
		<div class="sell-area ">
			...
			<span class="sale"
				style="background-color:{{ $prod->colors[$key] }}">{{ $prod->features[$key] }}
			</span>
			@endforeach
		</div>
		@endif
		...
		<img class="img-fluid "src="{{ $prod->photo ? asset('assets/images/thumbnails/'.$prod->thumbnail):asset('assets/images/noimage.png') }}"
			alt="">
	...
	<div class="info">
		...
		<h4 class="price">{{ $prod->showPrice() }}
			...
			<del>
				<small>{{ $prod->showPreviousPrice() }}</small>
			</del></h4>
		<div class="stars">
			<div class="ratings">
