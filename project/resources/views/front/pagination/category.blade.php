								...
								<script type="text/javascript">
								    $("#sortby").on('change', function () {
								        ...
								        @endif
								        @if(isset($subcat))
								        window.location = "{{url('/category')}}/{{$subcat->category->slug}}/{{$subcat->slug}}?sort=" +
								            sort;
								        @endif
								        @if(isset($childcat))
								        window.location =
								            "{{url('/category')}}/{{$childcat->subcategory->category->slug}}/{{$childcat->subcategory->slug}}/{{$childcat->slug}}?sort=" +
								            sort;
								        @endif
								    });
