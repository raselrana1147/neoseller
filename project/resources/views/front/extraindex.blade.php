		...
		<div class="row">
			<div class="col-lg-12 remove-padding">
				<div class="section-top">
					...
					<a href="{{route('view.all.product','bestseller')}}" style="position: absolute;right: 70px;top: 8px;background: #0f78f2" class="btn btn-success btn-sm"><i class="fas fa-eye"></i> View All</a>
				</div>
			</div>
		</div>
		<div class="row">
		...
		<div class="row">
			<div class="col-lg-12 remove-padding">
				<div class="section-top">
					...
					<a href="{{route('view.all.product','flashdeal')}}" style="position: absolute;right: 70px;top: 8px;background: #0f78f2" class="btn btn-success btn-sm"><i class="fas fa-eye"></i> View All</a>
				</div>
			</div>
		</div>
		<div class="row">
			...
			<div class="col-lg-12 remove-padding">
				<div class="section-top">
					<h2 class="section-title">
					 ...
					 <a href="{{route('view.all.product','toprated')}}" style="position: absolute;right: 70px;top: 8px;background: #0f78f2" class="btn btn-success btn-sm"><i class="fas fa-eye"></i> View All</a>
				</div>
			</div>
		</div>
		<div class="row">
		...
		<div class="row">
			<div class="col-lg-12 remove-padding">
				<div class="section-top">
					...
					<a href="{{route('view.all.product','bigsave')}}" style="position: absolute;right: 70px;top:8px;background: #0f78f2" class="btn btn-success btn-sm"><i class="fas fa-eye"></i> View All</a>
