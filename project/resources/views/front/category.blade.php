		...
		<div class="row">
			<div class="col-lg-12">
				<ul class="pages">
					...
					<li>
						<a
							href="{{route('front.category',$childcat->subcategory->category->slug)}}">{{$childcat->subcategory->category->name}}</a>
					</li>
					<li>
						<a
							href="{{route('front.subcat',['slug1' => $childcat->subcategory->category->slug, 'slug2' => $childcat->subcategory->slug])}}">{{$childcat->subcategory->name}}</a>
					</li>
					<li>
						<a
