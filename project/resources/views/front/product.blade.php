      ...
      <div class="col-lg-9">
        <div class="row">
          ...
          <div class="col-lg-5 col-md-12">
             ...
             {{--  <a href="{{route('downloadimage',$productt->id)}}" ><i class="fa fa-download" aria-hidden="true" style="margin-left: 300px"></i></a> --}}

              <a href="{{asset('assets/images/products/'.$productt->photo)}}" download id="keeppath"><i class="fa fa-download" aria-hidden="true" style="margin-left: 300px"></i></a>
                ...
                <div class="all-slider">
                  ...
                  <a  href="{{asset('assets/images/galleries/'.$gal->photo)}}">
                    <img class="xzoom-gallery5 " width="80" src="{{asset('assets/images/galleries/'.$gal->photo)}}"
                      title="The description goes here"  id="geturl">
                  </a>
              ...
              <div class="product-info">
                ...
                <div class="product-price">
                  ...
                  <p class="price">
                    ...
                    @php
                         $today=date('m/d/Y');
                         $rr_date=strtotime($today);
                         $discountdate=strtotime($productt->discount_date);
                    @endphp
                    
                    @if($productt->is_discount==1 && $discountdate > $rr_date)

                        <span id="sizeprice">Fresh deal {{ $productt->fresh_price }}$</span>
                      @else
                ...
                <div class="info-meta-3">
                  <ul class="meta-list">
                        ...
                        <ul>
                         ...
                         @endif
                          <li>
                            ...
                            <span style="margin-left: 10px">Set price: </span><input type="number" id="sellprice" class="sellprice" min="1" value="{{ $productt->rrshowPrice() }}">
                          </li>
                        </ul>
                      </div>
                    </li>
                    ...
                    @else 
                    <li class="addtocart">
                      <a href="javascript:;" id="addcrt" ><i class="icofont-cart "></i>{{ _("Add to Cart") }}</a>
                    </li>

                    {{-- <li class="addtocart">
                      <a href="{{ route('product.cart.quickadd',$productt->id) }}"><i
                          class="icofont-cart"></i>{{ _("Buy Now") }}</a>
                    </li> --}}
                    @endif
                  ...
                  @if(Auth::guard('web')->check())
                  <li class="favorite">
                    <a href="javascript:;" class="add-to-shop"
                      data-href="{{ route('user-shop-add',$productt->id) }}"><i class="fas fa-store"></i></i></a>
                  </li>
                  @else
                  <li class="favorite">
                      <a href="javascript:;" data-toggle="modal" data-target="#comment-log-reg"><i
              ...
              <div class="tab-content-wrapper">
                <div id="tabs-1" class="tab-content-area">
                 ...
                 <button id="copybutton" data-clipboard-target="#copydescription" class="btn btn-info">Copy content</button>
                  ...
                  <div id="copydescription">{!! $productt->details !!}</div>
                ...
                <div id="tabs-2" class="tab-content-area">
                  <button id="copypolicy" data-clipboard-target="#copypolicycontent" class="btn btn-info">Copy content</button>
                  
                   <div id="copypolicycontent">{!! $productt->policy !!}</div>
...
<script src="{{asset('assets/front/js/clickboard.js')}}"></script>
...
<script type="text/javascript">
  ...
  $(document).on("submit", "#emailreply1", function () {
    ...
    /// get sell price
    $(".rrsellpriixe").on('click',function(){
...
$(document).ready(function(){
   ...
   var clipboard = new ClipboardJS('#copybutton',{
      container: document.getElementById('copydescription')
  });

    var clipboardpolicy = new ClipboardJS('#copypolicy',{
      container: document.getElementById('copypolicycontent')
  });

      clipboardpolicy.on('success', function(e) {
          console.log(e);
      });

      clipboardpolicy.on('error', function(e) {
          console.log(e);
      });



      $('body').on("click","#keeppath", function(){
        var path=$('#xzoom-magnific').attr('src');
        $('#keeppath').attr('href',path);
        console.log(path);
      });
