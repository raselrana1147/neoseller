            ...
            <form id="geniusform" action="{{ route('admin-ps-homeupdate') }}" method="POST"
              ...
              <div class="row justify-content-center">
                <div class="col-lg-4 d-flex justify-content-between">
                  <label class="control-label" for="slider">{{ __('Slider and Featured Links') }} *</label>
                  <label class="switch">
                ...
                <div class="col-lg-4 d-flex justify-content-between">
                  <label class="control-label" for="featured_banner">{{ __('Featured Banner') }} *</label>
                  <label class="switch">
                    <input type="checkbox" name="featured_banner" value="1" {{$data->featured_banner==1?"checked":""}}>
                    <span class="slider round"></span>
                  </label>
                </div>
              </div>
              ...
              <div class="row justify-content-center">
                ...
                <div class="col-lg-4 d-flex justify-content-between">
                  <label class="control-label" for="review_blog">{{ __('Review') }} *</label>
                  <label class="switch">
