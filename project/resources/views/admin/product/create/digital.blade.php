			...
			<a href="javascript:;" id="crop-image" class="d-inline-block mybtn1">
				<i class="icofont-upload-alt"></i> {{ __("Upload Image Here") }}
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<input name="special_com" step="1" type="number" class="input-field" placeholder="Special Commission" min="0">
													</div>
												</div>
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<ul class="list">
															<li>
																<input class="checkclick1rr" name="olq" type="checkbox"  value="1">
