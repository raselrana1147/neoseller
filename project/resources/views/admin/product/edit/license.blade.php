			...
			<a href="javascript:;" id="crop-image" class="d-inline-block mybtn1">
				<i class="icofont-upload-alt"></i> {{ __("Upload Image Here") }}
												...
												<div class="row">
													<div class="col-lg-4">
														<div class="left-area">
																<h4 class="heading">{{ __('Special Commission') }}</h4>
																<p class="sub-heading">{{ __('(Optional)') }}</p>
														</div>
													</div>
													<div class="col-lg-7">
														<input name="special_com" step="1" type="number" class="input-field" value="{{$data->special_com}}" min="0">
													</div>
												</div>
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<ul class="list">
															<li>
																<input class="checkclick1rr" name="olq" type="checkbox"  value="1" {{ ($data->olq==1) ? 'checked' : ''}} >
																<label for="olq">{{ __('Limit Order Quantity') }}</label>
															</li>
														</ul>
													</div>
												</div>
