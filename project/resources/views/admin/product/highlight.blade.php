									                  ...
									                  <div class="col-sm-6">
									                      <input type="text" class="input-field" name="discount_date"  placeholder="{{ __("Enter Date") }}" id="discount_date" value="{{ $data->discount_date }}">
															...
															<div class="row">
																<div class="col-lg-6">
																	<div class="left-area">
																			<h4 class="heading">{{ __("Fresh price") }} *</h4>
																	</div>
																</div>
												                  <div class="col-sm-6">
												                      <input type="number" class="input-field" name="fresh_price"  placeholder="{{ __("Enter Date") }}" id="fresh_price" value="{{ $data->fresh_price }}">
...
if(this.checked)
{
	...
	$('#fresh_price').prop('required',true);
}
	...
	$('#fresh_price').prop('required',false);
}
