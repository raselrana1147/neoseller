                                    ...
                                    <div class="special-box">
                                        ...
                                        <div class="table-responsive-sm">
                                            <table class="table">
                                                ...
                                                <tr>
                                                    <th width="45%">{{ __('Company Get') }}</th>
                                                    <td width="10%">:</td>
                                                    <td width="45%">{{$order->currency_sign}}{{ round($order->company_get) }}</td>
                                                </tr>
                                                <tr>
                                                    <th width="45%">{{ __('Affilate Charge') }}</th>
                                                    <td width="10%">:</td>
                                                    <td width="45%">{{$order->currency_sign}}{{ round($order->affilate_charge) }}</td>
                                                </tr>
                ...
                <td width="45%">{{$order->shipping_zip == null ? $order->customer_zip : $order->shipping_zip}}</td>
                            ...
                            <div class="row">
                              ...
                              <a href="javascript:;" data-toggle="modal" data-target="#confirm-delete" class="btn btn-info product-btn" id="license" style="padding: 5px 12px;"><i class="fa fa-eye"></i> {{ __('View License') }}</a>
                                            ...
                                            <td>{{$product['size']}}</td>
                                            <td>{{App\Models\Product::find($product['item']['id'])->pro_owner}}</td>
                                            <td>{{App\Models\Product::find($product['item']['id'])->proid}}</td>
