                    ...
                    <div class="order-history">
                        ...
                        <form id="userform" class="form-horizontal" action="{{route('user-wwt-store')}}" method="POST"
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-4" for="name">{{ $langg->lang355 }}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <input name="amount" placeholder="{{ $langg->lang344 }}" class="form-control"
                            ...
                            <div id="paypal" style="display: none;">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <input name="acc_email" placeholder="{{ $langg->lang345 }}" class="form-control"
                            ...
                            <div id="bank" style="display: none;">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <input name="iban" value="{{ old('iban') }}" placeholder="{{ $langg->lang346 }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <input name="acc_name" value="{{ old('accname') }}"
                                            placeholder="{{ $langg->lang347 }}" class="form-control" type="text">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <input name="address" value="{{ old('address') }}"
                                            placeholder="{{ $langg->lang348 }}" class="form-control" type="text">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <input name="swift" value="{{ old('swift') }}"
                                            placeholder="{{ $langg->lang349 }}" class="form-control" type="text">
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <textarea class="form-control" name="reference" rows="6"
                                        placeholder="{{ $langg->lang350 }}">{{ old('reference') }}</textarea>
                                </div>
                            </div>
                            ...
                            <div id="resp" class="col-md-12">
                                ...
                                <span class="help-block">
                                    <strong>{{ $langg->lang351 }} ${{ $gs->withdraw_fee }} {{ $langg->lang352 }}
                                        {{ $gs->withdraw_charge }}% {{ $langg->lang353 }}</strong>
                                </span>
                            </div>
                            ...
                            <div class="add-product-footer">
                                <button name="addProduct_btn" type="submit"
                                    class="mybtn1">{{ $langg->lang354 }}</button>
                            </div>
                        </form>
